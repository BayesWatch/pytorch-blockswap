...
parser.add_argument('--student_checkpoint', '-s', default='wrn_40_2_student_KT', type=str,
...
if __name__ == '__main__':
    ...
    if args.mode == 'teacher':
        ...
        teach = WideResNet(args.wrn_depth, args.wrn_width, num_classes=num_classes, dropRate=0).to(device)
        ...
        student = WideResNet(args.wrn_depth, args.wrn_width, masked=True,
