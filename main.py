...
def random_conv_sub(net,param_target):
    ...
    while((get_no_params(net) > param_target) or (get_no_params(net) < (param_target-(param_target*0.05)))):
        ...
        net   = WideResNet(args.wrn_depth, args.wrn_width, Conv, MaskBlock,
                    ...
                    s=args.AT_split, convs=convs).cuda()
    return convs
...
if __name__ == '__main__':
    ...
    def load_network(loc, masked=False):
        ...
        net = WideResNet(args.wrn_depth, args.wrn_width, SavedConv, SavedBlock, num_classes=num_classes, dropRate=0,masked=masked).cuda()
    ...
    if args.mode == 'teacher':
        ...
        if args.moonshine:
            ...
            student = WideResNet(depth, width, Conv, BasicBlock, num_classes=num_classes, dropRate=0, masked=True, convs=convs).cuda()
            ...
            student = WideResNet(args.wrn_depth, args.wrn_width, Conv, BasicBlock, num_classes=num_classes, dropRate=0,masked=True).cuda()
